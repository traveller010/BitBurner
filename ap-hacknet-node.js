...
export async function main(ns) {
    ...
    // FIX: Prevents startup crashes by hibernating until Formulas.exe is purchased
    while (!ns.fileExists("Formulas.exe", "home")) {
        ns.print("💤 [DORMANT] Waiting for Formulas.exe to unlock ROI calculations...");
        await ns.sleep(60000); // Check once per minute
    }
